/**
 * Database Schema for Rubbin Hood
 *
 * Complete SQLite schema for the prediction market analytics platform.
 * Includes tables, indexes, and views as specified in SPEC-v3.md.
 */
...
/**
 * SQL Schema for raw .sql file export
 */
